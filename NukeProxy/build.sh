...
echo "sharpie bind"
sharpie bind --sdk=iphoneos17.2 --output="Output" --namespace="MPowerKit.ImageCaching.Nuke" --scope="Output/NukeProxy.xcframework/ios-arm64/NukeProxy.framework/Headers" "Output/NukeProxy.xcframework/ios-arm64/NukeProxy.framework/Headers/NukeProxy-Swift.h"
