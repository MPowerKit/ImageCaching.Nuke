...
namespace MPowerKit.NukeProxy
{
    ...
    interface ImagePipeline
    {
        ...
        // -(void)loadScaledImageWithUrl:(NSURL * _Nonnull)url scale:(float)scale reloadIgnoringCachedData:(BOOL)reloadIgnoringCachedData onCompleted:(void (^ _Nonnull)(UIImage * _Nullable, NSString * _Nonnull))onCompleted;
        [Export("loadScaledImageWithUrl:scale:reloadIgnoringCachedData:onCompleted:")]
        void LoadScaledImageWithUrl(NSUrl url, float scale, bool reloadIgnoringCachedData, Action<UIImage, NSString> onCompleted);
        ...
        // -(void)loadImageWithUrl:(NSURL * _Nonnull)url placeholder:(UIImage * _Nullable)placeholder errorImage:(UIImage * _Nullable)errorImage into:(UIImageView * _Nonnull)into onCompleted:(void (^ _Nonnull)(UIImage * _Nullable, NSString * _Nonnull))onCompleted;
        [Export("loadImageWithUrl:placeholder:errorImage:into:onCompleted:")]
        void LoadImageWithUrl(NSUrl url, [NullAllowed] UIImage placeholder, [NullAllowed] UIImage errorImage, UIImageView into, Action<UIImage, NSString> onCompleted);

        // -(void)loadImageWithUrl:(NSURL * _Nonnull)url placeholder:(UIImage * _Nullable)placeholder errorImage:(UIImage * _Nullable)errorImage into:(UIImageView * _Nonnull)into reloadIgnoringCachedData:(BOOL)reloadIgnoringCachedData onCompleted:(void (^ _Nonnull)(UIImage * _Nullable, NSString * _Nonnull))onCompleted;
        [Export("loadImageWithUrl:placeholder:errorImage:into:reloadIgnoringCachedData:onCompleted:")]
        void LoadImageWithUrl(NSUrl url, [NullAllowed] UIImage placeholder, [NullAllowed] UIImage errorImage, UIImageView into, bool reloadIgnoringCachedData, Action<UIImage, NSString> onCompleted);

        // -(void)loadImageWithUrl:(NSURL * _Nonnull)url imageIdKey:(NSString * _Nonnull)imageIdKey placeholder:(UIImage * _Nullable)placeholder errorImage:(UIImage * _Nullable)errorImage into:(UIImageView * _Nonnull)into onCompleted:(void (^ _Nonnull)(UIImage * _Nullable, NSString * _Nonnull))onCompleted;
        [Export("loadImageWithUrl:imageIdKey:placeholder:errorImage:into:onCompleted:")]
        void LoadImageWithUrl(NSUrl url, string imageIdKey, [NullAllowed] UIImage placeholder, [NullAllowed] UIImage errorImage, UIImageView into, Action<UIImage, NSString> onCompleted);

        // -(void)loadImageWithUrl:(NSURL * _Nonnull)url imageIdKey:(NSString * _Nonnull)imageIdKey placeholder:(UIImage * _Nullable)placeholder errorImage:(UIImage * _Nullable)errorImage into:(UIImageView * _Nonnull)into reloadIgnoringCachedData:(BOOL)reloadIgnoringCachedData onCompleted:(void (^ _Nonnull)(UIImage * _Nullable, NSString * _Nonnull))onCompleted;
        [Export("loadImageWithUrl:imageIdKey:placeholder:errorImage:into:reloadIgnoringCachedData:onCompleted:")]
        void LoadImageWithUrl(NSUrl url, string imageIdKey, [NullAllowed] UIImage placeholder, [NullAllowed] UIImage errorImage, UIImageView into, bool reloadIgnoringCachedData, Action<UIImage, NSString> onCompleted);
